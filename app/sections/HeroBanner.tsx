      ...
      <div className="w-full flex flex-col lg:flex-row relative">
        ...
        <div className="w-full lg:w-[45%] py-12 px-8 lg:py-24 lg:pr-12 lg:pl-12 xl:pl-20 2xl:pl-32 flex flex-col justify-center z-10 bg-white">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <Link to="/nts-catalogue" className="bg-white border-2 border-[#00A859] text-[#00A859] h-12 px-7 rounded-full font-bold hover:bg-green-50 transition-colors flex items-center justify-center gap-2 min-w-[172px] whitespace-nowrap">
              VIEW CATALOGUE
