  ...
  return (
    <section className="max-w-[1440px] mx-auto px-8 py-16">
      ...
      >
        ...
        <button 
          onClick={() => scroll('left')}
          className="absolute left-[-20px] lg:left-[-40px] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#00a87a] text-white flex items-center justify-center z-10 hover:bg-[#00c896] transition-colors shadow-md active:scale-95"
        ...
        <button 
          ...
          className="absolute right-[-20px] lg:right-[-40px] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#00a87a] text-white flex items-center justify-center z-10 hover:bg-[#00c896] transition-colors shadow-md active:scale-95"
